...
class NumbersAi extends StatefulWidget {
  NumbersAi({
    required this.page,
  });
  final String page;
  ...
  @override
  _NumbersAiState createState() => _NumbersAiState();
}

class _NumbersAiState extends State<NumbersAi> with WidgetsBindingObserver {
