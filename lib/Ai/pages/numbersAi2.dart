...
import 'package:labib/Ai/pages/StartScreen.dart';
...
class NumbersAi2 extends StatefulWidget {
  NumbersAi2({
    required this.page,
  });
  final String page;
  ...
  @override
  _NumbersAi2State createState() => _NumbersAi2State();
}

class _NumbersAi2State extends State<NumbersAi2> with WidgetsBindingObserver {
