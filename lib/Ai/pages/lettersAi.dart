...
class LettersAi extends StatefulWidget {
  LettersAi({
    required this.page,
  });
  final String page;
  ...
  @override
  _LettersAiState createState() => _LettersAiState();
}

class _LettersAiState extends State<LettersAi> with WidgetsBindingObserver {
  ...
  List<String> qElist = ["sheen", "aleff", "khaa", "waw", "bb"];
