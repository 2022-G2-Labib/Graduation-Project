...
class Number extends AiModel {
  ...
  Future<void> loadModel() async {
    try {
      ...
      interpreter ??= await Interpreter.fromAsset('models/number_model.tflite',
...
Map<String, dynamic>? runNumberDetector(Map<String, dynamic> params) {
  final number = Number(
    interpreter: Interpreter.fromAddress(params['detectorAddress']),
  );
  final image = ImageUtils.convertCameraImage(params['cameraImage']);
  final result = number.predict(image!);
