// ignore_for_file: prefer_const_constructors, deprecated_member_use, sized_box_for_whitespace, file_names, avoid_print
...
class _WordsTestState extends State<WordsTest> {
  ...
  Future<void> update(int testResult) async {
    await _databaseService.updateTestResult(testResult, 'wordsTest');
  }
          ...
          SizedBox(
              ...
              child: Stack(children: [
                ...
                Positioned(
                    ...
                    child: Image.asset(
                      "assets/WordsGame/wordsQ" + qnum.toString() + ".gif",
                                            ...
                                            showDialog(
                                                ...
                                                builder:
                                                  ...
                                                  return AlertDialog(
                                                    ...
                                                    title: Center(
                                                        child: Text(
                                                      "!انتهت عدد المحاولات \n حصلت على نتيجة "+ currentQ.toString() +"/9",
                                                      textAlign:
                                                          TextAlign.center,
                                                      style: TextStyle(
                                                          fontSize: 20,
