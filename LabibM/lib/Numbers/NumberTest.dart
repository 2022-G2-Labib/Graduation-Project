// ignore_for_file: prefer_const_constructors, deprecated_member_use, avoid_print, file_names, use_key_in_widget_constructors, prefer_final_fields, sized_box_for_whitespace, non_constant_identifier_names
...
class _NumberTest extends State<NumberTest> {
  ...
  Future<void> update(int testResult) async {
    await _databaseService.updateTestResult(testResult, 'numbersTest');
  }
}
